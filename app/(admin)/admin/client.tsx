...
import { User as UserData } from "@/components/user-wrapper";
...
const collegeContacts = [
  { college: "Lovett", name: "Sharon O'Leary", email: "sko1@rice.edu" },
  { college: "Baker", name: "Kristen Luu", email: "kl161@rice.edu" },
  { college: "Will Rice", name: "Amanda Garza", email: "ag276@rice.edu" },
  { college: "Hanszen", name: "Joyce Bald", email: "joyce@rice.edu" },
  { college: "Wiess", name: "Jenny Toups", email: "jt87@rice.edu" },
  { college: "Jones", name: "Kellie Sager", email: "ks235@rice.edu" },
  { college: "Brown", name: "Christy Cousins", email: "cc233@rice.edu" },
  { college: "Sid", name: "Lisa Galloy", email: "lgalloy@rice.edu" },
  { college: "Martel", name: "Bonnie Stroman", email: "brs3126@rice.edu" },
  {
    college: "McMurtry",
    name: "Jackie Carrizales",
    email: "jjc3@rice.edu",
  },
  { college: "Duncan", name: "Wendy Olivares", email: "wo5@rice.edu" },
];
...
export default function Component(coord: UserData) {
  ...
  useEffect(() => {
    ...
    if (currentCoord) {
      setLoading(true);
      fetchStudentsGivenCollege(currentCoord.college)
        .then(async (result) => {
